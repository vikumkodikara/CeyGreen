...
/**
 * Shared integration-test base: real MongoDB and Kafka in containers, so tests exercise the
 * same engines as production rather than in-memory substitutes.
 *
 * <p>No PostgreSQL container — Disease Detection owns only the Mongo {@code diagnoses}
 * collection; the users table belongs to user-service.
 *
