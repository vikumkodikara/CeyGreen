...
public class SecurityConfig {
    ...
    /**
     * Reachable without an access token. Only the docs and health probes are open, so the
     * service is inspectable on its own — every /diagnosis endpoint requires a token. This
     * service issues no credentials, so it has no public register or login path.
     */
    ...
    private JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        authorities.setAuthoritiesClaimName(JwtClaims.CLAIM_ROLE);
