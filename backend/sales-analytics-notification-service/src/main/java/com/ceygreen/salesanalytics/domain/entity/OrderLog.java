...
public class OrderLog {
    ...
    public OrderLog(Long id, String farmerId, String orderId, BigDecimal amount, String product, LocalDateTime recordedAt) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public OrderLog build() {
            return new OrderLog(id, farmerId, orderId, amount, product, recordedAt);
        }
    }
}
