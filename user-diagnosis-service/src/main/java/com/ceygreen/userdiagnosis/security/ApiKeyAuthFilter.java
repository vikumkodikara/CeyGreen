 ...
 * User Management and Disease Detection endpoint requires {@code X-API-Key}, so a call that
 * bypasses the gateway is rejected even if the caller somehow has a bearer token.
 */
@Component
