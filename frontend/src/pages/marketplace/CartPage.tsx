...
export const CartPage: React.FC = () => {
  ...
  if (user?.role !== 'BUYER') {
    return (
      <div className="marketplace-page">
        <div className="alert alert-error">Only buyers can access the cart.</div>
      </div>
    );
  }
  ...
  if (items.length === 0) {
    return (
      <div className="marketplace-page">
        <PageHeader title="Your Cart" subtitle="Items you plan to purchase." />
  ...
  return (
    <div className="marketplace-page">
      <PageHeader
        ...
        actions={<Button variant="ghost" onClick={emptyCart}>Clear cart</Button>}
      />
